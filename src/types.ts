export interface Device { id: number; name: string; uniqueId: string; status: string; lastUpdate?: string; }
...
export interface User { id: number; name: string; email: string; administrator: boolean; readonly?: boolean; deviceReadonly?: boolean; disabled?: boolean; }
