...
export interface Position { id: number; deviceId: number; valid: boolean; latitude: number; longitude: number; speed: number; fixTime: string; serverTime?: string; deviceTime?: string; protocol?: string; attributes: Record<string, unknown> & { ignition?: boolean; motion?: boolean }; }
